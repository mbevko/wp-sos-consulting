...
<header class="main_header">
    <div class="overlay">
        ...
        <a href="<?php echo site_url('/about'); ?>"><button class="header_learn_more_btn">Learn More</button></a>
        <a href="<?php echo site_url('/contact'); ?>"><button class="header_contact_us_btn">Contact Us</button></a>
        </div>
    ...
    <article class="software">
        ...
        <div class="software_links">
            ...
            <a href="#" title="Project and Job Costing" class="sf_link_cont">
                <img
                    src="<?php echo get_template_directory_uri(); ?>/images/ColorOne/projectjobcosting.PNG">
                <p class="software_links_p">Project and Job Costing</p>
                <p class="software_links_p2">Lorem ipsum dolor, sit amet consectetur adipisicing
                    elit. Nesciunt, consectetur. Earum tempore praesentium quod atque incidunt
                    deleniti</p>
            </a>
            <a href="#" title="Distribution Manufacturing Barcoding" class="sf_link_cont"><img
            ...
            <a href="#" title="Fixed Assets" class="sf_link_cont"><img
            ...
            <a href="#" title="Alerts" class="sf_link_cont"><img
            ...
            <a href="#" title="Reporting Dashboards and Intelligence" class="sf_link_cont"><img
        ...
        <div class="software_links2_closed">
            <a href="#" title="Multi-Currency" class="sf_link_cont">
                <img
                    src="<?php echo get_template_directory_uri(); ?>/images/ColorOne/multicurrency.PNG">
                <p>Multi-Currency</p>
                <p class="software_links_p2">Lorem ipsum dolor, sit amet consectetur adipisicing
                    elit. Nesciunt, consectetur. Earum tempore praesentium quod atque incidunt
                    deleniti</p>
            ...
            <a href="#" title="Warehouse Management" class="sf_link_cont">
                <img
                    src="<?php echo get_template_directory_uri(); ?>/images/ColorOne/warehousemangement.PNG">
                <p>Warehouse Management</p>
                <p class="software_links_p2">Lorem ipsum dolor, sit amet consectetur adipisicing
                    elit. Nesciunt, consectetur. Earum tempore praesentium quod atque incidunt
                    deleniti</p>
            </a>
            <a href="#" title="Workflow Analysis" class="sf_link_cont"><img
