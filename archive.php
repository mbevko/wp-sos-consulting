  ...
  <div class="page-header-inner">
    <div class="page-header-top">
      <div class="page-header-left">
        ...
        <h1>Insights on ERP — <em>from people<br>who implement it.</em></h1>
        <p class="page-header-desc">Articles, client spotlights, and practical guides on ERP implementation, optimization, and the decisions that separate successful go-lives from the ones that don't stick.</p>
      </div>
      <!-- Search -->
...
<div class="archive-main">
  <div>
    ...
    <div class="article-grid" id="articleGrid">
      ...
      <?php
      // Pull ALL published posts — client-side JS handles filtering + pagination
      ...
      if ( $archive_query->have_posts() ) :
        while ( $archive_query->have_posts() ) : $archive_query->the_post();
          ...
          // ── Derive "type" from category slug ──
  ...
  <aside class="archive-sidebar">
    ...
    <div class="sdb-cta-card">
      <div class="sdb-cta-eyebrow">Free · No obligation</div>
